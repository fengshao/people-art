...
var devUrl = '//topics-cms.dev.wesai.com:8884/api/';
...
}else if (locationHref.indexOf("dev") != -1) {
	parms.editUrl = devUrl + "editSpecial";//post
	parms.getListUrl = devUrl + "getSpecialList" + cacheUrlData; //get
	parms.addUrl = devUrl + "addSpecial";//post
	parms.delUrl = devUrl + "delSpecial";//get
	parms.isloginUrl = devUrl + "isLogin";//get
	parms.loginOut = devUrl + "logout";//get
	parms.getSpecalTypeList = devUrl + "getSpecialTypeList?channel=1";//get
	parms.getOperateLogList = devUrl + "getOperateLogList";//get
	parms.editSpecialType = devUrl + "editSpecialType";
	parms.getShareList = devUrl + "getShareList";
	parms.addShare = devUrl + "addShare";
	parms.editShare = devUrl + "editShare";
	parms.getBackgroundList = devUrl + "getBackgroundList";
	parms.addBackground = devUrl + "addBackground";
	parms.editBackground = devUrl + "editBackground";
	parms.specialDeploy = devUrl + "special_deploy";
	parms.getGoodsTypeList = devUrl + "getGoodsTypeList";
	parms.addGoodsType = devUrl + "addGoodsType";
	parms.editGoodsType = devUrl + "editGoodsType";
	parms.delGoodsType = devUrl + "delGoodsType";
	parms.getGoodsList = devUrl + "getGoodsList";
	parms.addGoods = devUrl + "addGoods";
	parms.editGoods = devUrl + "editGoods";
	parms.delGoods = devUrl + "delGoods";
	parms.getActivityList = devUrl + "getActivityList";
	parms.addActivity = devUrl + "addActivity";
	parms.editActivity = devUrl + "editActivity";
	parms.delActivity = devUrl + "delActivity";
	parms.shelfActivity = devUrl + "shelfActivity";
	parms.offShelfActivity = devUrl + "offShelfActivity";
	parms.activityDeploy = devUrl + "activityDeploy";
}
