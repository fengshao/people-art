...
// 		$.ajax({
// 			type: "get",
// 			url: "http://www.askci.com/tools/getdata.ashx?jsoncallback=?",
// 			dataType: "jsonp",
// 			data: {"id": $("#hiddenid").val(), "type": "table"},
...
//
// 	tableshow();
// 	$("table td").delegate("click", function () {
// 		$(this).parent().find("input").attr("checked", "true")
// 	});
// 	$("#table").click(function () {
// 		tableshow()
// 	});
// 	$("#dcbtn").delegate("click", function () {
...
// 			type: "get",
// 			url: "http://www.askci.com/tools/getdata.ashx?jsoncallback=?",
// 			data: {"votenum": select, "id": $("#hiddenid").val(), "action": "vote", "type": "table"},
// 			dataType: "jsonp",
